...
public class TypeScriptUtil
{
    ...
    static
    {
        ...
        TYPE_NAME_BY_PRIMITIVE_TYPE_MAP.put(PrimitiveType.INT64, "bigint");
        ...
        TYPE_NAME_BY_PRIMITIVE_TYPE_MAP.put(PrimitiveType.UINT64, "bigint");
    ...
    /**
     * Map the name of a {@link uk.co.real_logic.sbe.PrimitiveType} to a JS primitive type name.
     *
    ...
    public static String generateLiteral(final PrimitiveType type, final String value)
    {
        ...
        final String castType = typeScriptTypeName(type);
        switch (type)
        {
            case CHAR:
            case UINT8:
            ...
            case FLOAT:
                literal = value; //value.endsWith("NaN") ? "Float.NaN" : value + "f";
                break;
            ...
            case UINT64:
                literal = value + "n"; //0x" + Long.toHexString(Long.parseLong(value)) + "n";
                break;

            case DOUBLE:
                literal = value; //value.endsWith("NaN") ? "Double.NaN" : value + "d";
                break;
        }
        ...
        throws IOException
    {
        ...
        out.append('\n')
            .append(indent).append(" *\n")
            .append(indent).append(" * @returns true if ").append(optionToken.name()).append(" set or false if not.\n")
            .append(indent).append(" */\n");
    }
        ...
        throws IOException
    {
        ...
        out.append('\n')
            ...
            .append(indent).append(" * @returns this for a fluent API.\n")
            .append(indent).append(" */\n");
    }
        ...
        final StringBuilder sb, final String indent, final Token propertyToken, final String typeName)
    {
        ...
        sb.append('\n')
            .append(indent).append(" *\n")
            .append(indent).append(" * @returns ").append(typeName).append(" : ");
        ...
        final StringBuilder sb, final String indent, final Token propertyToken, final String typeName)
    {
        ...
        sb.append("\n")
            ...
            .append(indent).append(" * @returns ").append(typeName).append(" : encoder for the group.\n")
            .append(indent).append(" */");
    }
